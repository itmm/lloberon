...
TEST(Formal_Parameter_Section_Tests, simple) {
	...
	Formal_Parameter_Section_Runner test1 {
		"a: ARRAY OF INTEGER", formal_parameter_section
	};
}
...
TEST(Formal_Parameter_Section_Tests, multiple) {
	...
	sema::Formal_Parameter_Section formal_parameter_section { scope };
	Formal_Parameter_Section_Runner test1 {
		"a, b: INTEGER", formal_parameter_section
	};
}
...
TEST(Formal_Parameter_Section_Tests, var_parameter) {
	...
	sema::Formal_Parameter_Section formal_parameter_section { scope };
	Formal_Parameter_Section_Runner test1 {
		"VAR a: INTEGER", formal_parameter_section
	};
}
...
TEST(Formal_Parameter_Section_Tests, incomplete) {
	...
	sema::Formal_Parameter_Section formal_parameter_section { scope };
	Formal_Parameter_Section_Runner test1 {
		"VAR", formal_parameter_section, true
	};

	formal_parameter_section.clear();
	Formal_Parameter_Section_Runner test2 {
		"a,", formal_parameter_section, true
	};

	formal_parameter_section.clear();
	Formal_Parameter_Section_Runner test3 {
		"a INTEGER", formal_parameter_section, true, true
	};
}