...
bool Parser::parse_repeat_statement(lloberon::sema::Repeat_Statement& repeat_statement) {
    if (consume(token::keyword_REPEAT)) { return true; }
    lloberon::sema::Statement_Sequence statement_sequence { repeat_statement.scope() };
