...
type::Type_Ptr type::Type::base_boolean {
	std::make_shared<Type>(llvm::Type::getInt1Ty(context::get_context()))
};

type::Type_Ptr type::Type::base_char {
	std::make_shared<Type>(llvm::Type::getInt8Ty(context::get_context()))
};

type::Type_Ptr type::Type::base_integer {
	std::make_shared<Type>(llvm::Type::getInt32Ty(context::get_context()))
};

type::Type_Ptr type::Type::base_real {
	std::make_shared<Type>(llvm::Type::getDoubleTy(context::get_context()))
};
